...
\restrict CHuPuDr7fEaIutTPsYLQ0VgHKsdND9IpRU4V1Pbgm1CAXG0bM1VX1NiyiKbAqnr
...
COPY public.employee_review (employee_review_id, employee_id, employee_name, review_year, objective, key_result_target, key_result_actual, date_created, date_updated) FROM stdin;
\.
...
4	2	PTO	2025	17.0	0.0	17.0	2025-11-02
...
335	2	Sick Leave	2025	5.0	0.0	5.0	2025-11-02
...
SELECT pg_catalog.setval('public.time_off_requests_request_id_seq', 3, true);
...
\unrestrict CHuPuDr7fEaIutTPsYLQ0VgHKsdND9IpRU4V1Pbgm1CAXG0bM1VX1NiyiKbAqnr
