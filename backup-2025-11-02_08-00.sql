...
\restrict fGJzvFu46N1hT3p80NPM4QvpOTmm50s3LPgkO3tHR61NE1P179l5tcTEAJlYgfx
...
CREATE TABLE public.benefits_catalog (
    ...
    enrollment_window character varying,
    created_at date,
    updated_at date,
...
--
-- Name: employee_review; Type: TABLE; Schema: public; Owner: neill
--

CREATE TABLE public.employee_review (
    ...
    key_result_pct numeric(3,2),
    date_created date,
    date_updated date
);


ALTER TABLE public.employee_review OWNER TO neill;

--
-- Name: employee_review_employee_review_id_seq; Type: SEQUENCE; Schema: public; Owner: neill
--

CREATE SEQUENCE public.employee_review_employee_review_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.employee_review_employee_review_id_seq OWNER TO neill;

--
-- Name: employee_review_employee_review_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neill
--

ALTER SEQUENCE public.employee_review_employee_review_id_seq OWNED BY public.employee_review.employee_review_id;
...
--
-- Name: time_off; Type: TABLE; Schema: public; Owner: neill
--
...
CREATE TABLE public.time_off (
    ...
    end_date date,
    type character varying,
    time_off_amount numeric,
    time_off_accrued numeric,
    time_off_balance numeric,
    date_created date,
    date_updated date
);


ALTER TABLE public.time_off OWNER TO neill;

--
-- Name: time_off_time_off_id_seq; Type: SEQUENCE; Schema: public; Owner: neill
--

CREATE SEQUENCE public.time_off_time_off_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.time_off_time_off_id_seq OWNER TO neill;

--
-- Name: time_off_time_off_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: neill
--

ALTER SEQUENCE public.time_off_time_off_id_seq OWNED BY public.time_off.time_off_id;
...
--
-- Name: employee_review employee_review_id; Type: DEFAULT; Schema: public; Owner: neill
--

ALTER TABLE ONLY public.employee_review ALTER COLUMN employee_review_id SET DEFAULT nextval('public.employee_review_employee_review_id_seq'::regclass);
...
--
-- Name: time_off time_off_id; Type: DEFAULT; Schema: public; Owner: neill
--

ALTER TABLE ONLY public.time_off ALTER COLUMN time_off_id SET DEFAULT nextval('public.time_off_time_off_id_seq'::regclass);
...
COPY public.benefits_catalog (benefit_catalog_id, benefit_name, benefit_category, description, employer_contribution, employee_contribution, dependent_coverage_allowed, eligibility_criteria, enrollment_window, created_at, updated_at, benefit_plan_id, employee_pays, employer_pays, total_plan_cost) FROM stdin;
1	Aetna PPO Gold	Medical	High-tier PPO plan offering broad provider access and low copays.	0.80	0.20	t	Full-time employees	Annual Open Enrollment	2024-01-01	2024-01-01	1	120.00	480.00	600.00
2	Blue Cross PPO Silver	Medical	Mid-tier PPO plan balancing cost and coverage with national network.	0.75	0.25	t	Full-time employees	Annual Open Enrollment	2024-01-01	2024-01-01	2	150.00	450.00	600.00
3	Kaiser HMO Basic	Medical	Managed-care HMO plan offering cost-effective care through Kaiser network providers.	0.85	0.15	t	Full-time employees in CA Region	Annual Open Enrollment	2024-01-01	2024-01-01	3	90.00	510.00	600.00
4	VSP Vision Premier	Vision	Premium vision plan with full-frame allowance and contacts coverage.	0.80	0.20	t	Full-time employees	Annual Open Enrollment	2024-01-01	2024-01-01	4	2.00	8.00	10.00
5	EyeMed Vision Standard	Vision	Affordable plan covering routine eye exams and basic lenses.	0.75	0.25	t	Full-time employees	Annual Open Enrollment	2024-01-01	2024-01-01	5	2.50	7.50	10.00
6	Delta Dental PPO Premium	Dental	Comprehensive PPO dental plan with national coverage and orthodontia options.	0.75	0.25	t	Full-time employees	Annual Open Enrollment	2024-01-01	2024-01-01	6	5.00	15.00	20.00
7	Cigna Dental HMO Basic	Dental	Affordable HMO dental plan with low premiums and in-network coverage.	0.80	0.20	t	Full-time employees	Annual Open Enrollment	2024-01-01	2024-01-01	7	4.00	16.00	20.00
8	MetLife Basic Life	Life Insurance	Company-provided life insurance covering 1x annual salary, fully employer-paid.	1.00	0.00	f	All employees	Automatic Enrollment	2024-01-01	2024-01-01	8	0.00	5.00	5.00
9	Fidelity 401(k) Standard	Retirement	401(k) retirement savings plan with 50% employer match up to 6% of salary.	0.50	0.50	f	Full-time employees	Rolling Enrollment	2024-01-01	2024-01-01	9	\N	\N	\N
\.
...
--
-- Data for Name: employee_review; Type: TABLE DATA; Schema: public; Owner: neill
--

COPY public.employee_review (employee_review_id, employee_id, employee_name, review_year, strategy_id, objective, key_result_target, key_result_actual, key_result_pct, date_created, date_updated) FROM stdin;
\.
...
COPY public.roles (role_id, role_name, role_level, parent_role_id, job_family_id, description, date_created, date_updated, department_id) FROM stdin;
1	Associate Product Manager	IC1	\N	1	Supports product research and feature development	2025-10-30	2025-10-30	2
2	Product Manager	IC2	\N	1	Owns product roadmap and delivery priorities	2025-10-30	2025-10-30	2
3	Senior Product Manager	IC3	\N	1	Leads cross-functional product strategy	2025-10-30	2025-10-30	2
4	Director of Product Management	M2	\N	1	Oversees product portfolio and roadmap	2025-10-30	2025-10-30	2
5	VP of Product	Exec1	\N	1	Owns overall product vision and direction	2025-10-30	2025-10-30	2
6	Software Engineer	IC1	\N	2	Builds and maintains software features	2025-10-30	2025-10-30	1
7	Senior Software Engineer	IC2	\N	2	Leads complex system design and architecture	2025-10-30	2025-10-30	1
8	Engineering Manager	M1	\N	2	Leads development teams and technical delivery	2025-10-30	2025-10-30	1
9	Director of Product Development	M2	\N	2	Oversees product build and release processes	2025-10-30	2025-10-30	1
10	VP of Product Development	Exec1	\N	2	Leads engineering and delivery for all products	2025-10-30	2025-10-30	1
11	IT Support Specialist	IC1	\N	3	Provides user and systems support	2025-10-30	2025-10-30	3
12	Systems Administrator	IC2	\N	3	Manages infrastructure and enterprise systems	2025-10-30	2025-10-30	3
13	IT Manager	M1	\N	3	Oversees IT operations and service management	2025-10-30	2025-10-30	3
14	Director of IT	M2	\N	3	Leads enterprise technology operations	2025-10-30	2025-10-30	3
15	CTO	Exec1	\N	3	Defines technology vision and architecture	2025-10-30	2025-10-30	3
16	R&D Engineer	IC1	\N	4	Designs and prototypes new technologies	2025-10-30	2025-10-30	4
17	Research Scientist	IC2	\N	4	Conducts technical and market research	2025-10-30	2025-10-30	4
18	R&D Manager	M1	\N	4	Leads research and innovation teams	2025-10-30	2025-10-30	4
19	Director of R&D	M2	\N	4	Oversees research initiatives and partnerships	2025-10-30	2025-10-30	4
20	Sales Representative	IC1	\N	5	Manages outreach and prospecting	2025-10-30	2025-10-30	5
21	Account Executive	IC2	\N	5	Closes deals and manages customer pipeline	2025-10-30	2025-10-30	5
22	Sales Manager	M1	\N	5	Leads sales teams and regional goals	2025-10-30	2025-10-30	5
23	VP of Sales	Exec1	\N	5	Owns revenue and growth strategy	2025-10-30	2025-10-30	5
24	Marketing Coordinator	IC1	\N	6	Supports campaigns and content creation	2025-10-30	2025-10-30	6
25	Marketing Manager	M1	\N	6	Oversees programs and campaign execution	2025-10-30	2025-10-30	6
26	Director of Marketing	M2	\N	6	Leads marketing strategy and performance	2025-10-30	2025-10-30	6
27	Chief Marketing Officer	Exec1	\N	6	Owns brand and go-to-market strategy	2025-10-30	2025-10-30	6
28	Customer Support Specialist	IC1	\N	7	Resolves customer issues and inquiries	2025-10-30	2025-10-30	7
29	Customer Service Team Lead	IC2	\N	7	Oversees service team workflow	2025-10-30	2025-10-30	7
30	Customer Service Manager	M1	\N	7	Manages service KPIs and escalation processes	2025-10-30	2025-10-30	7
31	Director of Customer Service	M2	\N	7	Leads overall service operations	2025-10-30	2025-10-30	7
32	HR Coordinator	IC1	\N	8	Supports HR operations	2025-10-30	2025-10-30	8
33	HR Business Partner	IC2	\N	8	Advises business units on people strategy	2025-10-30	2025-10-30	8
34	Director of HR	M2	\N	8	Oversees HR programs and compliance	2025-10-30	2025-10-30	8
35	Chief People Officer	Exec1	\N	8	Leads company culture and people strategy	2025-10-30	2025-10-30	8
36	Financial Analyst	IC1	\N	9	Prepares reports and forecasts	2025-10-30	2025-10-30	9
37	Accounting Manager	M1	\N	9	Manages accounting processes	2025-10-30	2025-10-30	9
38	Director of FP&A	M2	\N	9	Oversees planning and financial modeling	2025-10-30	2025-10-30	9
39	Chief Financial Officer	Exec1	\N	9	Leads financial and investment strategy	2025-10-30	2025-10-30	9
40	Legal Counsel	IC2	\N	10	Manages contracts and legal issues	2025-10-30	2025-10-30	10
41	Director of Compliance	M2	\N	10	Oversees compliance and policy programs	2025-10-30	2025-10-30	10
42	General Counsel	Exec1	\N	10	Leads legal and governance strategy	2025-10-30	2025-10-30	10
43	Chief of Staff	M2	\N	11	Coordinates executive priorities	2025-10-30	2025-10-30	11
44	VP, Strategy & Transformation	Exec1	\N	11	Drives enterprise strategy and change	2025-10-30	2025-10-30	11
45	CEO	Exec2	\N	11	Leads overall company performance and vision	2025-10-30	2025-10-30	11
\.


--
-- Data for Name: time_off; Type: TABLE DATA; Schema: public; Owner: neill
--

COPY public.time_off (time_off_id, employee_id, start_date, end_date, type, time_off_amount, time_off_accrued, time_off_balance, date_created, date_updated) FROM stdin;
\.
...
--
-- Name: employee_review_employee_review_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neill
--

SELECT pg_catalog.setval('public.employee_review_employee_review_id_seq', 1, false);
...
--
-- Name: time_off_time_off_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neill
--

SELECT pg_catalog.setval('public.time_off_time_off_id_seq', 1, false);
...
--
-- Name: employee_review employee_review_pkey; Type: CONSTRAINT; Schema: public; Owner: neill
--

ALTER TABLE ONLY public.employee_review
    ADD CONSTRAINT employee_review_pkey PRIMARY KEY (employee_review_id);
...
--
-- Name: time_off time_off_pkey; Type: CONSTRAINT; Schema: public; Owner: neill
--
...
--
-- Name: employee_review employee_review_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neill
--

ALTER TABLE ONLY public.employee_review
    ADD CONSTRAINT employee_review_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES public.employees(employee_id);
...
--
-- Name: time_off time_off_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: neill
--

ALTER TABLE ONLY public.time_off
    ADD CONSTRAINT time_off_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES public.employees(employee_id);
...
\unrestrict fGJzvFu46N1hT3p80NPM4QvpOTmm50s3LPgkO3tHR61NE1P179l5tcTEAJlYgfx
